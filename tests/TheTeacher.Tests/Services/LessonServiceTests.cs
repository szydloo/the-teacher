...
namespace TheTeacher.Tests.Services
{
    public class LessonServiceTests
    {
        ...
        public async Task adding_lesson_should_invoke_get_lesson_from_sp_once()
        {
            ...
            tcs.SetResult(new Teacher(tId, new User(id,"email@email.com","test","test","test","user")));
        ...
        public async Task getting_teachers_with_specific_lesson_should()
        {
            ...
            var t1 = new Teacher(t1Id, new User(id,"email@email.com","test","test","test","user"));
            var t2 = new Teacher(t2Id, new User(id2,"email2@email.com","test2","test2","test2","user"));            
