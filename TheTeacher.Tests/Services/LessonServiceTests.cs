...
namespace TheTeacher.Tests.Services
{
    public class LessonServiceTests
    {
        ...
        public async Task adding_lesson_should_invoke_get_lesson_from_sp_once()
        {
            ...
            tcs.SetResult(new Teacher(new User(id,"email@email.com","test","test","test","user","test"),"testtest"));
        ...
        public async Task getting_teachers_with_specific_lesson_should()
        {
            ...
            var t1 = new Teacher(new User(id,"email@email.com","test","test","test","user","test"),"testtest");
            var t2 = new Teacher(new User(id2,"email2@email.com","test2","test2","test2","user","test2"),"testtest2");
